...
A gene-synthesis composer in three tabs (the main menu bar stays on-screen so you can hop to another tool and back; your work persists if you leave and come back — no save prompt — and **Clear** is the explicit per-tab wipe):
